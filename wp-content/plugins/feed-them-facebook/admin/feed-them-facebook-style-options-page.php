...
class FTS_facebook_options_page
{
    ...
    function feed_them_facebook_options_page()
    {
        ...
        <div class="feed-them-social-admin-wrap">
            <h1>
                <?php _e('Facebook Feed Options', 'feed-them-facebook'); ?>
            </h1>
            <div class="use-of-plugin">
                <?php _e('Change the language, color and more for your facebook feed using the options below.', 'feed-them-facebook'); ?>
            </div>
            ...
            <form method="post" class="fts-facebook-feed-options-form" action="options.php">
                ...
                <div class="feed-them-social-admin-input-wrap">
                    <div class="fts-title-description-settings-page" style="padding-top:0; border:none;">
                        <h3>
                            <?php _e('Language Options', 'feed-them-facebook'); ?>
                        </h3>
                        <?php _e('You must have your Facebook API Token saved at the bottom of this page before this feature will work. This option will translate the FB Titles and Like Button or Box Text. It will not tranlate your actual post. To tranlate the Feed Them Facebook parts of this plugin just set your language on the <a href="options-general.php" target="_blank">wordpress settings</a> page. If would like to help translate please visit our', 'feed-them-facebook'); ?>
                    ...
                    <div class="feed-them-social-admin-input-label fts-twitter-text-color-label">
                        <?php _e('Language For Facebook Feeds', 'feed-them-facebook'); ?>
                    </div>
                    <select name="fb_language" id="fb-lang-btn" class="feed-them-social-admin-input">
                        <option value="en_US">
                            <?php _e('Please Select Option', 'feed-them-facebook'); ?>
                        </option>
                        <?php
                ...
                <div class="feed-them-social-admin-input-wrap">
                    <div class="feed-them-social-admin-input-label fts-twitter-text-color-label">
                        <?php _e('Hide Notice on Front End', 'feed-them-facebook'); ?>
                    </div>
                ...
                <div class="feed-them-social-admin-input-wrap">
                    <div class="fts-title-description-settings-page">
                        <h3>
                            <?php _e('Like Button or Box Options', 'feed-them-facebook'); ?>
                        </h3>
                    </div>
                    <div class="feed-them-social-admin-input-label fts-twitter-text-color-label">
                        <?php _e('Show Follow Button', 'feed-them-facebook'); ?>
                    </div>
                ...
                <div class="feed-them-social-admin-input-wrap" style="display:none">
                    <div class="feed-them-social-admin-input-label fts-twitter-text-color-label">
                        <?php _e('Show Profile Icon next to social option above', 'feed-them-facebook'); ?>
                    </div>
                    <select name="fb_show_follow_like_box_cover" id="fb-show-follow-like-box-cover" class="feed-them-social-admin-input">
                        ...
                        <option <?php echo selected($fb_show_follow_btn_profile_pic, 'fb_like_box_cover-yes', false) ?> value="fb_like_box_cover-yes">
                            <?php _e('Display Cover Photo in Like Box', 'feed-them-facebook'); ?>
                        </option>
                        <option <?php echo selected($fb_show_follow_btn_profile_pic, 'fb_like_box_cover-no', false) ?> value="fb_like_box_cover-no">
                            <?php _e('Hide Cover Photo in Like Box', 'feed-them-facebook'); ?>
                        </option>
                    </select>
                    <div class="clear"></div>
                </div>
                ...
                <div class="feed-them-social-admin-input-wrap">
                    <div class="feed-them-social-admin-input-label fts-twitter-text-color-label">
                        <?php _e('Like Button Color', 'feed-them-facebook'); ?>
                    </div>
                ...
                <div class="feed-them-social-admin-input-wrap">
                    <div class="feed-them-social-admin-input-label fts-twitter-text-color-label">
                        <?php _e('Placement of the Button(s)', 'feed-them-facebook'); ?>
                    </div>
                ...
                <div class="feed-them-social-admin-input-wrap">
                    <div class="feed-them-social-admin-input-label fts-twitter-text-color-label">
                        <?php _e('Facebook APP ID<br/><small>View Step 3 to <a href="http://www.slickremix.com/docs/create-facebook-app-id-or-user-token" target="_blank">get APP ID</a>.</small>', 'feed-them-facebook'); ?>
                    </div>
                ...
                <div class="feed-them-social-admin-input-wrap">
                    <div class="fts-title-description-settings-page" style="margin-top:0;">
                        <h3>
                            <?php _e('Style Options', 'feed-them-facebook'); ?>
                        </h3>
                    </div>

                    <div class="feed-them-social-admin-input-label fts-twitter-text-color-label">
                        <?php _e('Text after your FB name <br/><small>ie* Shared by or New Photo Added etc.</small>', 'feed-them-facebook'); ?>
                    </div>
                ...
                <div class="feed-them-social-admin-input-wrap">
                    <div class="feed-them-social-admin-input-label fts-twitter-text-color-label">
                        <?php _e('Hide Images in Posts', 'feed-them-facebook'); ?>
                    </div>
                ...
                <div class="feed-them-social-admin-input-wrap">
                    <div class="feed-them-social-admin-input-label fts-fb-text-color-label">
                        <?php _e('Max-width for Images & Videos', 'feed-them-facebook'); ?>
                    </div>
                ...
                <div class="feed-them-social-admin-input-wrap">
                    <div class="feed-them-social-admin-input-label fts-fb-text-color-label">
                        <?php _e('Feed Header Extra Text Color', 'feed-them-facebook'); ?>
                    </div>
                ...
                <div class="feed-them-social-admin-input-wrap">
                    <div class="feed-them-social-admin-input-label fts-fb-text-color-label">
                        <?php _e('Feed Text Color', 'feed-them-facebook'); ?>
                    </div>
                ...
                <div class="feed-them-social-admin-input-wrap">
                    <div class="feed-them-social-admin-input-label fts-fb-link-color-label">
                        <?php _e('Feed Link Color', 'feed-them-facebook'); ?>
                    </div>
                ...
                <div class="feed-them-social-admin-input-wrap">
                    <div class="feed-them-social-admin-input-label fts-fb-link-color-hover-label">
                        <?php _e('Feed Link Color Hover', 'feed-them-facebook'); ?>
                    </div>
                ...
                <div class="feed-them-social-admin-input-wrap">
                    <div class="feed-them-social-admin-input-label fts-fb-feed-width-label">
                        <?php _e('Feed Width', 'feed-them-facebook'); ?>
                    </div>
                ...
                <div class="feed-them-social-admin-input-wrap">
                    <div class="feed-them-social-admin-input-label fts-fb-feed-margin-label">
                        <?php _e('Feed Margin <br/><small>To center feed type auto</small>', 'feed-them-facebook'); ?>
                    </div>
                ...
                <div class="feed-them-social-admin-input-wrap">
                    <div class="feed-them-social-admin-input-label fts-fb-feed-padding-label">
                        <?php _e('Feed Padding', 'feed-them-facebook'); ?>
                    </div>
                ...
                <div class="feed-them-social-admin-input-wrap">
                    <div class="feed-them-social-admin-input-label fts-fb-feed-background-color-label">
                        <?php _e('Feed Background Color', 'feed-them-facebook'); ?>
                    </div>
                ...
                <div class="feed-them-social-admin-input-wrap">
                    <div class="feed-them-social-admin-input-label fts-fb-grid-posts-background-color-label">
                        <?php _e('Feed Grid Posts Background Color (Grid style feeds ONLY)', 'feed-them-facebook'); ?>
                    </div>
                ...
                <div class="feed-them-social-admin-input-wrap">
                    <div class="feed-them-social-admin-input-label fts-fb-border-bottom-color-label">
                        <?php _e('Feed Border Bottom Color', 'feed-them-facebook'); ?>
                    </div>
                ...
                <div class="feed-them-social-admin-input-wrap">
                    <div class="fts-title-description-settings-page">
                        <h3>
                            <?php _e('Event Style Options', 'feed-them-facebook'); ?>
                        </h3>
                        <?php _e('The styles above still apply, these are just some extra options for the Event List feed.', 'feed-them-facebook'); ?>
                    </div>
                    <div class="feed-them-social-admin-input-label fb-events-title-color-label">
                        <?php _e('Events Feed: Title Color', 'feed-them-facebook'); ?>
                    </div>
                ...
                <div class="feed-them-social-admin-input-wrap">
                    <div class="feed-them-social-admin-input-label fb-events-title-size-label">
                        <?php _e('Events Feed: Title Size', 'feed-them-facebook'); ?>
                    </div>
                ...
                <div class="feed-them-social-admin-input-wrap">
                    <div class="feed-them-social-admin-input-label fb-events-map-link-color-label">
                        <?php _e('Events Feed: Map Link Color', 'feed-them-facebook'); ?>
                    </div>
                ...
                <div class="feed-them-social-admin-input-wrap">
                    ...
                    <div class="feed-them-social-admin-input-wrap">
                        <div class="feed-them-social-admin-input-label fts-twitter-border-bottom-color-label">
                            <?php _e('APP Token', 'feed-them-facebook'); ?>
                        </div>
                    ...
                    <?php if (!empty($test_app_token_response)) {
                        if (isset($test_app_token_response->data->is_valid)) {
                            echo '<div class="fts-successful-api-token">' . __('Your APP Token is working!', 'feed-them-facebook') . '</div>';
                        }
                        if (isset($test_app_token_response->data->error->message) || isset($test_app_token_response->error->message)) {
                            if (isset($test_app_token_response->data->error->message)) {
                                echo '<div class="fts-failed-api-token">' . __('Oh No something\'s wrong.', 'feed-them-facebook') . ' ' . $test_app_token_response->data->error->message . '</div>';
                            }
                            if (isset($test_app_token_response->error->message)) {
                                echo '<div class="fts-failed-api-token">' . __('Oh No something\'s wrong.', 'feed-them-facebook') . ' ' . $test_app_token_response->error->message . '</div>';
                            }

                        }

                    } else {
                        echo '<div class="fts-successful-api-token">' . __('You are using our Default APP Token.', 'feed-them-facebook') . '</div>';
                    }
                    ?>
                    <div class="clear"></div>
                </div>
                ...
                <?php if (is_plugin_active('feed-them-social-facebook-reviews/feed-them-social-facebook-reviews.php')) { ?>
                    <div class="feed-them-social-admin-input-wrap">
                        <div class="fts-title-description-settings-page">
                            <h3>
                                <?php _e('Reviews Style Options', 'feed-them-facebook'); ?>
                            </h3>
                            <?php _e('The styles above still apply, these are just some extra options for the Reviews List feed.', 'feed-them-facebook'); ?>
                        </div>
                        <div class="feed-them-social-admin-input-label fb-events-title-color-label">
                            <?php _e('Stars Background Color', 'feed-them-facebook'); ?>
                        </div>
                    ...
                    <div class="feed-them-social-admin-input-wrap">
                        <div class="feed-them-social-admin-input-label fb-events-map-link-color-label">
                            <?php _e('Stars Text Color', 'feed-them-facebook'); ?>
                        </div>
                    ...
                    <div class="feed-them-social-admin-input-wrap">
                        <div class="fts-title-description-settings-page" style="margin-bottom:0px;">
                            <h3>
                                <?php _e('Facebook Page Reviews Access Token', 'feed-them-facebook'); ?>
                            </h3>
                            <?php _e('This Facebook Access Token works for the Reviews feed only. <a href="http://www.slickremix.com/facebook-never-expiring-page-token" target="_blank">Get your Page Access Token here</a>.', 'feed-them-facebook'); ?>
                        </div>
                        <div class="feed-them-social-admin-input-label fts-twitter-border-bottom-color-label">
                            <?php _e('Page Reviews Access Token', 'feed-them-facebook'); ?>
                        </div>
                    ...
                    <?php if (!empty($test_app_token_response_biz)) {
                        if (isset($test_app_token_response_biz->data->is_valid)) {
                            echo '<div class="fts-successful-api-token">' . __('Your Reviews Page Access Token is working!', 'feed-them-facebook') . '</div>';
                        }
                        if (isset($test_app_token_response_biz->data->error->message) || isset($test_app_token_response_biz->error->message)) {
                            if (isset($test_app_token_response_biz->data->error->message)) {
                                echo '<div class="fts-failed-api-token">' . __('Oh No something\'s wrong.', 'feed-them-facebook') . ' ' . $test_app_token_response_biz->data->error->message . '</div>';
                            }
                            if (isset($test_app_token_response_biz->error->message)) {
                                echo '<div class="fts-failed-api-token">' . __('Oh No something\'s wrong.', 'feed-them-facebook') . ' ' . $test_app_token_response_biz->error->message . '</div>';
                            }
